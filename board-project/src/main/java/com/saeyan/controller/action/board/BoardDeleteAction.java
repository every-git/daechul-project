...
public class BoardDeleteAction implements Action {
     ...
     *         - 권한 없음: "/board/boardView.jsp" (message 속성에 "삭제 권한이 없습니다." 저장)
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        // 5. 권한 없으면 message와 board 저장 후 "/board/boardView.jsp" 반환
        // 6. 권한 있으면 BoardDAO.getInstance().deleteBoard(seq) 호출
        // 7. "redirect:" + request.getContextPath() + "/BoardServlet?command=board_list" 반환
        return null;
    }
}
