 ...
 * 
 * 역할:
 * - 관리자 관련 모든 요청을 받아서 처리하는 중앙 집중식 컨트롤러
 ...
 * 2. 인코딩 설정 (UTF-8)
 * 3. command 파라미터 추출 (기본값: "admin_main")
 ...
 * 
 * URL 매핑: /AdminServlet (web.xml에서 설정)
 * 
 * 주의사항:
 * - 관리자 권한 체크는 각 Action에서 처리 (checkAdmin.jsp 포함)
 * 
 * web-study-11 패턴 적용
 */
public class AdminServlet extends HttpServlet {
     ...
     * 2. command 파라미터 추출 및 기본값 설정 ("admin_main")
