...
<body>
    <div class="container">
        ...
        <form action="<%= request.getContextPath() %>/MemberServlet?command=join" method="post" onsubmit="return validateJoinForm()">
            ...
            <div class="form-group">
                ...
                <span id="password_match" style="display:none; color: var(--success-color); margin-left: 10px;">✓ 비밀번호가 일치합니다</span>
                <span id="password_mismatch" style="display:none; color: var(--danger-color); margin-left: 10px;">✗ 비밀번호가 일치하지 않습니다</span>
            </div>
            ...
            <div class="form-group" id="admin_password_group" style="display:none;">
                ...
                <small style="color: var(--text-muted); display: block; margin-top: 5px;">관리자 가입을 위해서는 특별한 비밀번호가 필요합니다.</small>
            </div>
